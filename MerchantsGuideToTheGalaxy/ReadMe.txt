MerchantsGuideMain.java is the main class. It takes the fileName as a Command Line Input. If a 
Command Line Input is not passed the default file name input.txt is considered.
...
To run with a command line input:
gradlew run -Darg="input2.txt"
----------------------------------
